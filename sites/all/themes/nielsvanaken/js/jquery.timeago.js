...
(function(jQuery) {
  ...
  jQuery.extend(jQuery.timeago, {
    ...
    inWords: function(distanceMillis) {
      ...
      function substitute(stringOrFunction, number) {
        var string = jQuery.isFunction(stringOrFunction) ? stringOrFunction(number, distanceMillis) : stringOrFunction;
  ...
  function refresh() {
    ...
    if (!isNaN(data.datetime)) {
      jQuery(this).text(inWords(data.datetime));
    }
    return this;
  }
